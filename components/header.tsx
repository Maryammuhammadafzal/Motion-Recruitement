...
const Header = () => {
  return (
    ...
    <nav className="fixed bg-background shadow-sm shadow-background w-full z-20  top-0 start-0 pt-4 px-4 rounded-2xl border-default">
      <div className="w-full bg-primary rounded-2xl px-6 flex flex-wrap items-center justify-between mx-auto p-4">
        <a href="#" className="flex items-center lg:pl-6 space-x-3 rtl:space-x-reverse">
          <img src="/images/logo.svg" className="h-9" alt="Logo" />
        </a>
        <button data-collapse-toggle="navbar-multi-level-dropdown" type="button" className="inline-flex items-center p-2 w-10 h-10 justify-center text-sm text-background rounded-base md:hidden hover:bg-secondary hover:text-foreground focus:outline-none focus:ring-2 focus:ring-neutral-tertiary" aria-controls="navbar-multi-level-dropdown" aria-expanded="false">
          <span className="sr-only">Open main menu</span>
          <Menu size={40} />
          {/* <Image className="w-6 h-6" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24"><path stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M5 7h14M5 12h14M5 17h14"/></Image> */}
        </button>
        <div className="hidden w-full md:block md:w-auto text-background" id="navbar-multi-level-dropdown">
          <ul className="flex flex-col text-sm font-medium lg:p-4 p-1 md:p-0 mt-4 border border-default rounded-base  md:space-x-5 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0">
            <li>
            ...
            <li>
              ...
              <div id="multi-dropdown" className="z-10 hidden bg-neutral-primary-medium border border-default-medium rounded-base shadow-lg w-44">
                <ul className="p-2 text-sm text-body font-medium" aria-labelledby="multiLevelDropdownButton">
                  <li>
                    <a href="#" className="inline-flex items-center hover:text-foreground w-full p-2 hover:bg-neutral-tertiary-medium hover:text-heading rounded">Dashboard</a>
                  </li>
                  <li>
                    ...
                    <div id="doubleDropdown" className="z-10 hidden bg-neutral-primary-medium border border-default-medium rounded-base shadow-lg w-44">
                      <ul className="p-2 text-sm text-body font-medium" aria-labelledby="dropdownMultiLevelButton">
                        <li>
                          <a href="#" className="inline-flex items-center hover:text-foreground w-full p-2 hover:bg-neutral-tertiary-medium hover:text-heading rounded">Overview</a>
                        </li>
                        <li>
                          <a href="#" className="inline-flex items-center hover:text-foreground w-full p-2 hover:bg-neutral-tertiary-medium hover:text-heading rounded">My downloads</a>
                        </li>
                        <li>
                          <a href="#" className="inline-flex items-center hover:text-foreground w-full p-2 hover:bg-neutral-tertiary-medium hover:text-heading rounded">Billing</a>
                        </li>
                        <li>
                          <a href="#" className="inline-flex items-center hover:text-foreground w-full p-2 hover:bg-neutral-tertiary-medium hover:text-heading rounded">Rewards</a>
                        </li>
                      </ul>
                    </div>
                  </li>
                  <li>
                    <a href="#" className="inline-flex items-center hover:text-foreground w-full p-2 hover:bg-neutral-tertiary-medium hover:text-heading rounded">Earnings</a>
                  </li>
                  <li>
                    <a href="#" className="inline-flex items-center hover:text-foreground w-full p-2 hover:bg-neutral-tertiary-medium hover:text-heading rounded">Sign out</a>
                  </li>
                </ul>
              </div>
            </li>
